...
Product lock is where approved survey, shakedown, decisions, and UX preview
...
Produce `locked-spec.json` with enough evidence for the next Lodestar skill to continue without re-interrogating product intent.
