...
locked spec context, and worktree plan. It reports status using Lodestar's
...
Produce `implementation-handoff.json` with enough evidence for the next Lodestar skill to continue without re-interrogating product intent.
