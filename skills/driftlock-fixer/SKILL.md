---
name: driftlock-fixer
description: Apply fixes after build or review failure. Use when builder, reviewer, UX guard, or compound produces a concrete fix brief for an existing task.
---
...
Produce `fix-handoff.json`. Read `references/fixer-contract.md` for the exact contract.
